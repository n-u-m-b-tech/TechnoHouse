<%@ Page Title="" Language="C#" MasterPageFile="~/TechnoMaster.Master" AutoEventWireup="true" CodeBehind="EditProduct.aspx.cs" Inherits="FinalWeb.EditProduct" %>
...
<div class="flex-w flex-sb">
		 <div class="w-size13 p-t-30 respon5">
		  <div class="wrap-slick3 flex-sb flex-w">
            <h4 class="m-text26 p-b-36 p-t-15">Edit Product </h4>	
             ...
             <div class="bo4 of-hidden size15 m-b-20">
				<input class="sizefull s-text7 p-l-22 p-r-22" runat="server" id="url" type="text" name="name" placeholder="Image URL" required="">
                 ...
                 <div class="size14 trans-0-4 m-b-10">
					 <asp:Button ID="BtnEdit" runat="server"  Text="Update" class="flex-c-m sizefull bg1 bo-rad-23 hov1 s-text1 trans-0-4" OnClick="BtnEdit_Click"/>
				</div>              
        </div>
        </div>
    </div>
