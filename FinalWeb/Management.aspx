 ...
 <!--SideBar-->
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="EditProduct.aspx"><em class="fa fa-bar-chart">&nbsp;</em> Edit Product</a></li>
            <li><a href="EditProduct.aspx"><em class="fa fa-bar-chart">&nbsp;</em> Remove Product</a></li>
			<li><a href="EditUser.aspx"><em class="fa fa-bar-chart">&nbsp;</em> Edit User</a></li>
            <li><a href="elements.html"><em class="fa fa-toggle-off">&nbsp;</em> Stats </a></li>
