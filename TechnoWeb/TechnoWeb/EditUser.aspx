<%@ Page Title="" Language="C#" MasterPageFile="~/TechMaster.Master" AutoEventWireup="true" CodeBehind="EditUser.aspx.cs" Inherits="TechnoWeb.EditUser" %>
...
<div class="fields">
            <div class="field"> 
                ...
                <br />
                 ...
                 <input type="text" name="txttyper" id="user_type" placeholder="User Type" runat="server" />
                <br />
                <br />
